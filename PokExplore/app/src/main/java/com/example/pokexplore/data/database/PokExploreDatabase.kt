...
@Database(entities = [Pokemon::class, User::class, UserPokemon::class], version = 6)
@TypeConverters(ListConverter::class, StringMapConverter::class, IntMapConverter::class)
